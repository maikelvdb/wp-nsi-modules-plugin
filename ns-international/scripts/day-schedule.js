(function ($) {
  $(document).ready(function () {
    ...
    function createDayscheduleElement(entry, date) {
      ...
      const $dbButton = $(
        `<a href="https://www.awin1.com/awclick.php?gid=372445&mid=14964&awinaffid=374071&linkid=2476100&clickref=" class="db-button" target="_blank">` +
          php_vars.text_values["search_tickets"] +
